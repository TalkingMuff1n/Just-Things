 ...
 * ---------------------------------------------------------------------------
 * Creator's name and email: Josiah Truelove, truelovejm@etsu.edu Course: CSCI 1260-940
...
public class Club
{
	...
	/**
	 * This is only method I made for this project (6) because I needed a way to 
	 * get to the roster from the club, besides just the size lol         
	 *
	 * <hr>
